...
def main():
    ...
    try:
        if args.command=='inspect':
            b=SourceBSP(args.source);info=b.inspect();w=b.convert();res=Resolver(b,args.material_root,args.vpk)
            ...
            lib=Library(args.library,args.source_dir,args.host_test,args.icd if args.icd.is_file() else None,args.material_root,args.vpk)
